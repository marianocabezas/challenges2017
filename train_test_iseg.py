        ...
        try:
            ...
            if sequential:
                ...
                if experimental:
                    ...
                    brain_patch_in = concatenate([t2_e, t1_e], axis=1)
                    brain_patch_in = Permute((-1, 1))(brain_patch_in)
                    brain_patch = Dense(4, activation='softmax')(brain_patch_in)
                    brain_patch = Permute((-1, 1))(Dropout(0.5)(brain_patch))
